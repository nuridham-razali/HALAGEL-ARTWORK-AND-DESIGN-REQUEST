...
// Updated CheckBox to accept custom classes and styles for the label
const CheckBox = ({ 
  checked, 
  label, 
  className = "",
  labelClass = "text-sm font-bold", // Default style
  labelStyle = {} // Allow custom inline styles (e.g. for specific fonts)
}: { 
  checked: boolean; 
  label?: string; 
  className?: string;
  ...
  <div className={`flex items-center gap-2 ${className}`}>
    ...
    {label && <span className={`${labelClass} pt-0.5`} style={labelStyle}>{label}</span>}
  </div>
);
...
const LineField = ({ 
  ...
  multiline?: boolean;
    ...
    if (multiline && value) {
        ...
        else if (len > 50) fontSize = "text-[11px]";
    }
    ...
    return (
      <div className={`flex items-end gap-1 ${className}`}>
         ...
         <div className={`${width} border-b border-black relative min-h-[1.5rem]`}>
            ...
            */}
            <div className={`w-full text-black font-normal ${fontSize} uppercase leading-none whitespace-pre-wrap break-words pl-2 pb-0.5`} 
...
export const PdfTemplate = forwardRef<HTMLDivElement, PdfTemplateProps>(({ data }, ref) => {
  // Styles for the unbolded, size 12 text (previously 10)
  const standardOptionClass = "text-[12px] font-normal";
  // Specific style for Section C labels
  const sectionCLabelClass = "text-[12px] font-normal";
       ...
       <div className="border-2 border-black h-full flex flex-col">
          ...
          <div className="flex border-b-2 border-black h-24">
             ...
             <div className="w-[70%] flex flex-col">
                ...
                <div className="flex-1 flex items-center justify-center bg-gray-200/50 print:bg-gray-200">
                    <h2 className="text-lg font-bold uppercase tracking-tight" style={{ fontFamily: 'Arial, sans-serif' }}>ARTWORK & DESIGN REQUEST FORM</h2>
                </div>
             </div>
          </div>
          ...
          <div className="flex border-b-2 border-black divide-x-2 divide-black h-16">
             <div className="flex-1 p-2 flex flex-col justify-between">
               ...
               <div className="pl-2 text-black font-normal text-[12px]" style={{ fontFamily: 'Calibri, sans-serif' }}>{formatDate(data.date)}</div>
             </div>
             <div className="flex-1 p-2 flex flex-col justify-between">
               <span className="font-bold text-xs">Deadline :</span>
               <div className="pl-2 text-black font-normal text-[12px]" style={{ fontFamily: 'Calibri, sans-serif' }}>{formatDate(data.deadline)}</div>
             </div>
             <div className="flex-1 p-2 flex flex-col justify-between relative">
               <span className="font-bold text-xs">ADR No :</span>
               <div className="pl-2 text-black font-normal text-[12px]" style={{ fontFamily: 'Calibri, sans-serif' }}>{data.adrNo}</div>
          ...
          <div className="border-b-2 border-black">
            <div className="bg-gray-200 border-b border-black px-2 py-1 font-bold text-sm" style={{ fontFamily: 'Arial, sans-serif' }}>
                A) REQUESTOR DETAILS
            </div>
            <div className="p-3 space-y-3">
               ...
               <div className="flex items-center gap-2 pt-1">
                  ...
                  <div className="flex items-center gap-6">
                     <CheckBox checked={data.category === 'Halagel'} label="Halagel" labelClass={standardOptionClass} />
                     <div className="flex items-center gap-2">
                        <CheckBox checked={data.category === 'OEM'} label="OEM" labelClass={standardOptionClass} />
          ...
          <div className="border-b-2 border-black flex-1 flex flex-col">
             <div className="bg-gray-200 border-b border-black px-2 py-1 font-bold text-sm" style={{ fontFamily: 'Arial, sans-serif' }}>
                B) DETAILS REQUISITION <span className="text-[10px] font-normal italic ml-1 align-baseline" style={{ fontFamily: 'Calibri, sans-serif' }}>(as per registration/ notification)</span>
             </div>
             ...
             <div className="p-3 space-y-3 flex-1">
                ...
                <div className="flex items-start gap-2 pt-1">
                    ...
                    <div className="flex-1 flex gap-8">
                        <CheckBox checked={data.jobRequest.newDesign} label="New design" labelClass={standardOptionClass} />
                        <div className="flex items-center gap-2">
                            <CheckBox checked={data.jobRequest.amendment} label="Amendment" labelClass={standardOptionClass} />
                ...
                <div className="flex items-start gap-2 pt-1">
                    ...
                    <div className="flex-1 grid grid-cols-3 gap-y-2 gap-x-2">
                        <CheckBox checked={data.intendedFor.softgel} label="Softgel" labelClass={standardOptionClass} />
                        <CheckBox checked={data.intendedFor.toothpaste} label="Toothpaste" labelClass={standardOptionClass} />
                        <CheckBox checked={data.intendedFor.cosmetics} label="Cosmetics" labelClass={standardOptionClass} />
                        <div className="col-span-3 flex items-center gap-2">
                            <CheckBox checked={data.intendedFor.fnb} label="F&B" labelClass={standardOptionClass} />
                            <div className="w-4"></div>
                            <CheckBox checked={data.intendedFor.others} label="Others" labelClass={standardOptionClass} />
                ...
                <div className="flex items-start gap-2 pt-1">
                    ...
                    <div className="flex-1 flex flex-col gap-1">
                        <CheckBox checked={data.type.designArtwork} label="Design / Artwork" labelClass={standardOptionClass} />
                        <CheckBox checked={data.type.sampleLabel} label="Sample Label" labelClass={standardOptionClass} />
                        <CheckBox checked={data.type.mockup} label="Mockup" labelClass={standardOptionClass} />
                    </div>
                </div>
                   ...
                   <div className="flex-1 space-y-2">
                      ...
                      <div className="flex items-center gap-2">
                         ...
                         <div className="border-b border-dotted border-black w-48 h-5 relative flex items-center justify-center">
                             <span className="absolute bottom-[10px] text-black font-normal text-[12px] uppercase" style={{ fontFamily: 'Calibri, sans-serif' }}>
                      ...
                      <div className="flex items-center gap-2 w-full">
                         <CheckBox checked={data.infoRequired.others} label="Others" labelClass={standardOptionClass} />
                         <div className="flex-1">
                    ...
                    <div className="grid grid-cols-2 gap-x-12 gap-y-3 px-2">
                        ...
                        <div className="flex items-center gap-4">
                           ...
                           <div className="flex flex-col w-full">
                               <span className="font-normal text-[12px] underline">OTHERS:</span>
                               <div className="w-full border-b border-gray-400 relative h-6 mt-1">
                                    <span className="absolute bottom-[10px] left-0 text-black font-normal text-[12px] uppercase leading-none whitespace-nowrap overflow-visible z-10" style={{ fontFamily: 'Calibri, sans-serif' }}>
          ...
          <div className="border-b-2 border-black">
             ...
             <div className="grid grid-cols-2 divide-x-2 divide-black">
                ...
                <div className="p-4 flex flex-col h-52">
                   <div className="text-[12px] font-normal mb-6" style={{ fontFamily: 'Calibri, sans-serif' }}>Requested by,</div>
                   
                   <div className="flex flex-col gap-5 mt-auto">
                       <LineField label="Name" value={data.requestedByName} width="flex-1" labelClass={sectionCLabelClass} />
                       <LineField label="Position" value={data.requestedByPosition} width="flex-1" labelClass={sectionCLabelClass} />
                       <LineField label="Date" value={formatDate(data.date)} width="flex-1" labelClass={sectionCLabelClass} />
                   </div>
                </div>

                {/* Right Column - Increased height to h-52 for bigger box */}
                <div className="p-4 flex flex-col h-52">
                   <div className="text-[12px] font-normal mb-6" style={{ fontFamily: 'Calibri, sans-serif' }}>Received by,</div>
                   
                   <div className="flex flex-col gap-5 mt-auto">
                       <LineField label="Name" value="" width="flex-1" labelClass={sectionCLabelClass} />
                       <LineField label="Position" value="" width="flex-1" labelClass={sectionCLabelClass} />
                       <LineField label="Date" value="" width="flex-1" labelClass={sectionCLabelClass} />
                   </div>
                </div>
             </div>
          </div>
